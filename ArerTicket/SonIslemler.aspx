<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="SonIslemler.aspx.vb" Inherits="ArerTicket.SonIslemler" %>
    ...
    <form id="form1" runat="server">
        <section id="sidebar">
            ...
            <ul class="side-menu">
                ...
                <li><a href="#" class="active"><i class='bx bxs-check-square icon'></i>SON İŞLEMLER</a></li>
